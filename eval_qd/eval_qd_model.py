...
"""
CUDA_VISIBLE_DEVICES=0 nohup python eval_qd_model.py piqa none test 3 --sub_one goal --sub_two sol1 --sub_three sol2 --task_idx 4 > ./log/piqa.lb 2>&1 &
CUDA_VISIBLE_DEVICES=2 nohup python eval_qd_model.py Rowan/hellaswag none test 3 --sub_one ctx_a --sub_two ctx_b --sub_three activity_label --task_idx 3 > ./log/hellaswag.lb 2>&1 &
CUDA_VISIBLE_DEVICES=3 nohup python eval_qd_model.py winogrande winogrande_debiased test 3 --sub_one sentence --sub_two option1 --sub_three option2 --task_idx 0 > ./log/winogrande_debiased.lb 2>&1 &
CUDA_VISIBLE_DEVICES=4 nohup python eval_qd_model.py truthful_qa generation validation 2 --sub_one question --sub_two best_answer --task_idx 1 > ./log/generation.lb 2>&1 &
CUDA_VISIBLE_DEVICES=5 nohup python eval_qd_model.py truthful_qa multiple_choice validation 3 --sub_one question --sub_two mc1_targets --sub_three mc2_targets --task_idx 1 > ./log/multiple_choice.lb 2>&1 &
